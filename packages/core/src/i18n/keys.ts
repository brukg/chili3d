...
export const I18N_KEYS = [
    ...
    "command.modify.jointDynamics",
    "command.modify.powerBudget",
    "command.modify.applyMaterial",
    "command.modify.applyMotor",
    "command.modify.robotCenterOfMass",
    "command.modify.robotReach",
    "command.modify.robotReport",
    "command.modify.validateRobot",
    "command.modify.straightenedReach",
