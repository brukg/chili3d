...
export default {
    ...
    translation: {
        ...
        "command.measure.curvature": "曲率",
        "command.measure.area": "面积",
        "command.measure.perimeter": "周长",
        ...
        "command.modify.jointDynamics": "关节动力学",
        "command.modify.powerBudget": "功率预算",
        "command.modify.applyMaterial": "应用材料",
        "command.modify.applyMotor": "应用电机",
        "command.modify.robotCenterOfMass": "机器人质心",
        "command.modify.robotReach": "机器人臂展",
        "command.modify.straightenedReach": "完全伸展臂展",
        "command.modify.robotReport": "机器人报告",
        "command.modify.validateRobot": "校验机器人",
        "command.modify.stabilityCheck": "稳定性检查",
        "command.modify.payloadCapacity": "负载能力",
        ...
        "toast.measure.orientedBoundingBox:{0}{1}{2}": "有向包围盒：{0} × {1} × {2} mm",
        ...
        "toast.robot.straightReach:{0}": "完全伸展臂展：{0} mm",
        "toast.robot.report:{0}{1}{2}{3}": "机器人：{0} 个关节，{1} kg，{2} W，峰值力矩 {3}%",
        "toast.robot.valid": "机器人校验通过 — 未发现问题",
        "toast.robot.invalid:{0}{1}": "机器人：{0} 个错误，{1} 个警告 — 详见控制台",
        "toast.robot.power:{0}{1}{2}": "装机功率：{0} W；峰值关节 {1} 为 {2} W",
        ...
        "toast.measure.curvature:{0}{1}": "曲率：{0} /mm，曲率半径：{1} mm",
        "measure.density": "密度 (kg/m³)",
        "toast.measure.area:{0}": "总面积：{0} mm²",
        "toast.measure.perimeter:{0}": "周长：{0} mm",
