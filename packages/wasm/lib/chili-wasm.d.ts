...
export type GeomAbs_Shape = GeomAbs_ShapeValue<0>|GeomAbs_ShapeValue<2>|GeomAbs_ShapeValue<4>|GeomAbs_ShapeValue<5>|GeomAbs_ShapeValue<6>|GeomAbs_ShapeValue<1>|GeomAbs_ShapeValue<3>;
...
export type TopAbs_ShapeEnum = TopAbs_ShapeEnumValue<7>|TopAbs_ShapeEnumValue<6>|TopAbs_ShapeEnumValue<5>|TopAbs_ShapeEnumValue<4>|TopAbs_ShapeEnumValue<3>|TopAbs_ShapeEnumValue<2>|TopAbs_ShapeEnumValue<0>|TopAbs_ShapeEnumValue<1>|TopAbs_ShapeEnumValue<8>;
...
export interface Geom_Surface extends Geom_Geometry {
  ...
  d3(_0: number, _1: number, _2: gp_Pnt, _3: gp_Vec, _4: gp_Vec, _5: gp_Vec, _6: gp_Vec, _7: gp_Vec, _8: gp_Vec, _9: gp_Vec, _10: gp_Vec, _11: gp_Vec): void;
...
interface EmbindModule {
  ...
  ShapeFactory: {
    ...
    offsetSurface(_0: TopoDS_Shape, _1: number): ShapeResult;
    ...
    meshToShape(_0: Array<Vector3>): ShapeResult;
    ...
    draftAngle(_0: TopoDS_Shape, _1: Array<number>, _2: Vector3, _3: number, _4: Vector3, _5: Vector3): ShapeResult;
